<div>
    @include('gerant.nav')
    @section("titre",'Gestion des dépenses')
                                ...
                                <td>
                                    <div class="flex gap-2">
                                        ...
                                        @if ($expense->attachment_path)
                                            <a class="btn btn-sm" href="storage/{{ $expense->attachment_path }}" 
                                                data-fancybox
                                                data-src="storage/{{ $expense->attachment_path }}"
                                                data-caption="{{ $expense->motif }}" wire:navigate
                                                >
